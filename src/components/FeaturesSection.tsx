  ...
  const features = [
    {
      ...
      description:
        "Enterprise-grade security protocols to protect your data and systems.",
    },
    {
      icon: Zap,
      title: "Lightning Fast",
      description:
        "Optimized performance and speed for the best user experience.",
    },
    {
      icon: Users,
      title: "Expert Team",
    ...
    },
    {
      ...
      title: "Goal Oriented",
      description:
        "Focused approach to achieve your business objectives efficiently.",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Our solutions are built with performance, security, and innovation
            at their core — ensuring your business stays ahead in a fast-changing
            digital world.
          </p>
        </div>
