      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="hero-description text-lg md:text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            At TechVision, we help companies transform their ideas into powerful
            digital products. From web development to AI-driven solutions, we
            deliver excellence that drives growth and innovation.
          </p>
